...
public class HistoricalObject {
    private String imageUrl,eventName,resultUrl,status,homeTeam,liveUrl,sportId,week,matchCity,visitingTeam,visitingScore,date;
    private String eventId,group,statusCn,stadium,sportName,homeScore,title,round,newsUrl,scheduleId,newsId,season,seasonCn;
